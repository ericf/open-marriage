...
app.locals({
    ...
    subnav: {
        wedding: [
            {id: 'details',        url: '/wedding/',                label: 'Details'},
            {id: 'transportation', url: '/wedding/transportation/', label: 'Transportation'},
            {id: 'hotels',         url: '/wedding/hotels/',         label: 'Hotels'}
        ]
    },
...
app.get('/wedding/transportation/', routes.render('wedding/transportation'));
app.get('/wedding/hotels/',         routes.render('wedding/hotels'));
